...
<html lang="en">
	...
	<head>
		...
		<!-- Theme CSS -->
		<link href="{{ URL::asset('/back/assets/vendor/font-awesome/css/font-awesome.min.css') }}assets/css/jquery.mmenu.css" rel="stylesheet" />
	...
	<body>
				...
				<div class="body-login">
					<div class="center-login">
						<a href="#" class="logo pull-left hidden-xs">
							<img src="{{ URL::asset('/back/assets/img/logo.png') }}" height="45" alt="NADHIF Admin" />
						</a>
						...
						<div class="panel panel-login">
							...
							<div class="panel-body">
								<form action="index.html" method="post">
									...
									<p class="text-center">Don't have an account yet? <a href="{{ url('admin/register')}}"><small>Register!</small></a>
								</form>
							</div>
						</div>
					</div>
		...
		<script src="{{ URL::asset('/back/assets/vendor/bootstrap/js/bootstrap.min.js') }}assets/vendor/bootstrap/js/bootstrap.min.js"></script>
		...
		<!-- Pages JS -->
		<script src="{{ URL::asset('/back/assets/js/pages/page-login.js') }}"></script>
