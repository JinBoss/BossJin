...
<html lang="en">
	...
	<body>
						...
						<div class="panel panel-register">
							...
							<div class="panel-body">
								<form>
									...
									<p class="text-center">Already have an account? <a href="{{ url('admin/login') }}"><small>Login!</small></a>
								</form>
							</div>
						</div>
					</div>
		...
		<!-- Pages JS -->
		<script src="{{ URL::asset('/back/assets/js/pages/page-register.js') }}"></script>
