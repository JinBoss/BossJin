...
<html lang="en">
	...
	<head>
		...
		<link rel="apple-touch-icon" sizes="76x76" href="{{ URL::asset('/back/assets/js/core.min.jsassets/ico/apple-touch-icon-76x76.png') }}" />
	...
	<body>
		...
		<!-- Pages JS -->
		<script src="{{ URL::asset('/back/assets/js/pages/weathericons.js') }}"></script>
