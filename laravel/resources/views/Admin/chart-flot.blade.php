...
<html lang="en">
	...
	<head>
		...
		<!-- Plugins CSS-->
		<link href="{{ URL::asset('/back/ssets/plugins/bootkit/css/bootkit.css') }}a" rel="stylesheet" />
	...
	<body>
					...
					<ul class="notifications hidden-sm hidden-xs">
						...
						<li>
							...
							<ul class="dropdown-menu">
								...
								<li class="avatar">
									<a href="page-inbox.html">
										<img class="avatar" src="{{ URL::asset('/back/assets/ico/favicon.ico') }}" alt="" />
										<div><div class="point point-primary point-lg"></div>New message</div>
							...
							<nav id="menu" class="nav-main" role="navigation">
								<ul class="nav nav-sidebar">
									<div class="panel-body text-center">								
										<div class="bk-avatar">
											<img src="{{ URL::asset('/back/assets/ico/favicon.ico') }}assets/img/avatar.jpg" class="img-circle bk-img-60" alt="" />
										</div>
		...
		<!-- Pages JS -->
		<script src="{{ URL::asset('/back/assets/js/pages/charts-flot.js') }}"></script>
